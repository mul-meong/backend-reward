...
import com.mulmeong.reward.point.application.MemberPointHttpService;
...
public class MemberPointController {
    ...
    private final MemberPointHttpService memberPointHttpService;
    ...
    public BaseResponse<MemberPointDto> getMemberPoint(@PathVariable String memberUuid) {
        return new BaseResponse<>(memberPointHttpService.getMemberPoint(memberUuid));
    }
}
